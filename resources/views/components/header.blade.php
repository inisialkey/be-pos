    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                ...
                <li><a href="features-profile.html" class="dropdown-item has-icon">
                        <i class="far fa-user"></i> Profile
                    </a></li>
                <li><a href="features-activities.html" class="dropdown-item has-icon">
                        <i class="fas fa-bolt"></i> Activities
                    </a></li>
                <li><a href="features-settings.html" class="dropdown-item has-icon">
