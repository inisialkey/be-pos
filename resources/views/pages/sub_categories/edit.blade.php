    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="/features/sub-categories/{{ $sub_category->id }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="description" value="{{ $sub_category->description }}">
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('category_id') is-invalid @enderror" name="category_id">
                                    @foreach ($categories as $category)
                                        @if (old('category_id', $sub_category->category_id) == $category->id)
